CREATE SCHEMA IF NOT EXISTS shows_movies;

CREATE TABLE shows_movies.titles (
    id TEXT,
    title TEXT,
    type TEXT,
    description TEXT,
...
CREATE TABLE shows_movies.credits (
    id TEXT,
    name TEXT,
    role TEXT,
    character TEXT
...
COPY shows_movies.titles
FROM 'C:\Users\Bishnu\Downloads\shirt - Google Search\titles.csv'
DELIMITER ','
CSV HEADER;

COPY shows_movies.credits
FROM 'C:\Users\Bishnu\Downloads\shirt - Google Search\credits.csv'
DELIMITER ','
CSV HEADER;
